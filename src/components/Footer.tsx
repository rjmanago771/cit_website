      ...
      <div className="footer-main">
        <div className="footer-container">
          <div className="footer-section">
            <h3>About CIT</h3>
            <p>
              College of Information and Technology at the University of the Assumption.
      ...
      <div className="footer-bottom">
        <div className="footer-container">
          <div className="footer-bottom-content">
            ...
            <p>&copy; 2025 College of Information and Technology, University of the Assumption. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
